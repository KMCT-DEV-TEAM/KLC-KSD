...
const AboutHeroSection = () => {
  return (
    <section className="relative w-full min-h-[80vh] md:min-h-screen flex items-center pt-32 pb-16 md:pt-0 md:pb-0 bg-slate-900" data-aos="fade-up">
      {/* Background Image */}
      <div className="absolute inset-0 w-full h-full">
        <Image
          src="/images/hero-bg.png"
          alt="About KMCT College of Legal Studies"
          fill
          priority
